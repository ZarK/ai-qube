...
export function renderLinearIssueDraft(draft: WorkItemDraft): LinearIssueDraft {
...
function linearPriority(priority: WorkItemDraft["priority"]): number {
...
function statusName(status: WorkItemDraft["status"]): string {
