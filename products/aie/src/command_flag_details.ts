...
export const INIT_FLAG_DETAILS: CommandFlagSchema[] = [
  ...
  { name: '--local-review-agent', type: 'string', description: 'Installed agent harness that runs native review subagents', multiple: true },
  { name: '--isolated-review-agent', type: 'string', description: 'Selected agent harness that runs isolated review' },
  { name: '--review-model', type: 'string', description: 'Live review model in host:model form', multiple: true },
  { name: '--review-backup-harness', type: 'string', description: 'Backup isolated review harness, or none', options: ['none', 'opencode', 'codex', 'claude-code', 'grok-build', 'cursor'] },
  { name: '--review-backup-model', type: 'string', description: 'Exact live model for the backup review harness' },
  { name: '--review-backup-effort', type: 'string', description: 'Effort for a non-Cursor backup review harness', options: ['low', 'medium', 'high'] },
  ...
  { name: '--quality-control', type: 'boolean', description: 'Record intent to run Quality gates when available' },
  { name: '--no-quality-control', type: 'boolean', description: 'Do not record Quality gate intent' },
...
export const PR_GATE_FLAG_DETAILS: CommandFlagSchema[] = [
  ...
  { name: '--full-review', type: 'boolean', description: 'Force a full-diff review pass instead of a delta re-review', default: false },
  { name: '--help', type: 'boolean', description: 'Show command help' },
];
