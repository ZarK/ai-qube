...
describe("CLI foundation", () => {
  it("shows help and exits with 0", async () => {
    ...
    expect(stdout.value).toContain(
      "By default aiq, aiq run, and aiq plan use .qube/aiq/progress.json current_stage, order, and disabled fields when present",
    );
    expect(stdout.value).toContain("restore the cumulative stages from 0 through N");
