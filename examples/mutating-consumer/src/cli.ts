...
import { createDryRunPlan, createDryRunPlanFields, renderDryRunPlan, renderMutationWarning } from "@tjalve/qube-cli/mutation";
...
export const consumerCli = createCli({
  ...
  ...packageIdentity,
  description: "Mutating consumer CLI validating @tjalve/qube-cli dry-run adoption.",
