...
function buildProfile(id: AgentHostId): AgentHostCapabilityProfile {
  ...
  const capabilities = Object.freeze({
    ...
    "review-isolated": capability("review-isolated", declared(d.isolatedReview, `QUBE can invoke ${displayName} for isolated read-only review.`, `${displayName} isolated review is not available yet.`, "Use native host review, or select a harness that supports isolated review.")),
