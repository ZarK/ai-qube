...
- AIE lifecycle mutations for GitLab issue state, labels, comments, assignees, completion, merge request approval, merge, discussion resolution, and pipeline triggering are explicitly unsupported until tested mutation adapters exist.
