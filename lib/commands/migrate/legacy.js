...
const spec = (0, command_metadata_1.getCommandSpec)('migrate legacy');
class MigrateLegacy extends base_command_1.NotImplementedCommand {
    static id = spec.id;
