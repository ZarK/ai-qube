...
const spec = (0, command_metadata_1.getCommandSpec)('deps blockers');
class DepsBlockers extends base_command_1.NotImplementedCommand {
    static id = spec.id;
