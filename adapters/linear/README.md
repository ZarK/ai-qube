...
```sh
npm install --save-exact --ignore-scripts @tjalve/qube-adapter-linear@0.1.6 @tjalve/qube-core@0.2.6
```

Or install QUBE and initialize the provider:

```sh
npm install --save-exact --ignore-scripts @tjalve/qube@0.2.12 @tjalve/qube-adapter-linear@0.1.6
qube init --work-provider linear --yes
```
