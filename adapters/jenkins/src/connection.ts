...
export async function probeJenkinsConnection(options: ConnectionProbeOptions = {}): Promise<ConnectionProbeResult> {
  return runConnectionProbe(jenkinsConnectionContract, {
    ...options,
