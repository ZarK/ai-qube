...
export async function probeGitLabConnection(options: ConnectionProbeOptions = {}): Promise<ConnectionProbeResult> {
  return runConnectionProbe(gitLabConnectionContract, {
    ...options,
