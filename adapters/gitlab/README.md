...
```sh
npm install --save-exact --ignore-scripts @tjalve/qube-adapter-gitlab@0.1.8 @tjalve/qube-core@0.2.6
```

Or install QUBE and initialize the provider:

```sh
npm install --save-exact --ignore-scripts @tjalve/qube@0.2.12 @tjalve/qube-adapter-gitlab@0.1.8
qube init --work-provider gitlab --yes
```
