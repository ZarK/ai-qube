...
export async function probeJiraConnection(options: ConnectionProbeOptions = {}): Promise<ConnectionProbeResult> {
  return runConnectionProbe(jiraConnectionContract, {
    ...options,
