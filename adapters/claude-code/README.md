...
```sh
npm install --save-exact --ignore-scripts @tjalve/qube-adapter-claude-code@0.1.1 @tjalve/qube-core@0.2.1
```
...
qube install --scope local --host claude-code --work-provider github --yes
```
